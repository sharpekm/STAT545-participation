...
#because there's a column for attendance
...
##    label          x         y
##    <chr>      <dbl>     <dbl>
##  1 Sample A -1.13    0.322   
##  2 Sample A  0.444   1.88    
##  3 Sample A -1.60   -2.80    
##  4 Sample A  0.846  -0.750   
##  5 Sample A  1.67    1.52    
##  6 Sample A  0.465   0.407   
##  7 Sample A  0.0327  1.25    
##  8 Sample A  1.20    1.75    
##  9 Sample A  0.756   0.000658
## 10 Sample A  0.593  -0.141   
## # ... with 90 more rows
```
...
##   <chr>  <chr> <dbl>         <dbl>         <dbl>
## 1 Alex   a         1         0.759         0.117
## 2 Alex   a         2         0.449         0.142
## 3 Alex   a         3         0.604         0.723
## 4 Robert b         1         0.630         0.324
## 5 Robert b         2         0.821         0.887
## 6 Robert b         3        NA            NA    
## 7 Sam    a         1         0.308         0.928
## 8 Sam    a         2        NA            NA    
## 9 Sam    a         3        NA            NA
```
