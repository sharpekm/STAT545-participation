...
facet_wrap --- takes plot and makes a panel for each categorical variable
...
Want to switch x and y from the bar plot.
...
![](cm008-exercise_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
